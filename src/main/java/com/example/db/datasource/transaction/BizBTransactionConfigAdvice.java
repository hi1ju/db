...
//@Configuration
public class BizBTransactionConfigAdvice {

    private PlatformTransactionManager platformTransactionManager;

    public BizBTransactionConfigAdvice(@Qualifier("bizBTransactionManager") PlatformTransactionManager platformTransactionManager) {
    ...
    @Bean
    public DefaultPointcutAdvisor transactionAdviceAdvisor() {
